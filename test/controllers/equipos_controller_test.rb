...
class EquiposControllerTest < ActionController::TestCase
  ...
  test "should create equipo" do
    assert_difference('Equipo.count') do
      post :create, equipo: { convocatoria_id: @equipo.convocatoria_id, encuentro_id: @equipo.encuentro_id, equ_citado: @equipo.equ_citado }
    end
  ...
  test "should update equipo" do
    patch :update, id: @equipo, equipo: { convocatoria_id: @equipo.convocatoria_id, encuentro_id: @equipo.encuentro_id, equ_citado: @equipo.equ_citado }
    assert_redirected_to equipo_path(assigns(:equipo))
  end
